...
const OrganizationsCreate = () => import('~/pages/organizations/create').then(m => m.default || m);
...
const routes = [
    ...
    {path: '/organizations/create', name: 'organizations.create', component: OrganizationsCreate},
];
