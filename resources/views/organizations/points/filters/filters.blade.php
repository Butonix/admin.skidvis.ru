{!! Form::open(['url' => route('points.index', $organization), 'method' => 'GET', 'class' => 'form-inline onChangeSubmit']) !!}
{{ Form::search('search', $frd['search'] ?? old('search') ?? null, [
	'data-source' => '/', //route('users.autocomplete')
	'aria-label' => 'Recipients organization',
	'aria-describedby' => 'points__search',
	'placeholder' => "Поиск...",
	'autocomplete' => 'off',
...
<div class="btn-group mb-3" role="group">
    <a class="btn btn-outline-secondary " href="{{ route('points.index', $organization) }}"
