{!! Form::open(['url' => route('organizations.index'), 'method' => 'GET', 'class' => 'form-inline onChangeSubmit']) !!}
...
{!! Form::select('points', ['ASC' => 'По возрастанию', 'DESC' => 'По убыванию'], $frd['points'] ?? old('points') ?? null, [
	'placeholder' => 'Кол-во точек',
	'class' => 'form-control js-switch-ordering mr-2 mb-3',
]) !!}
{!! Form::select('products', ['ASC' => 'По возрастанию', 'DESC' => 'По убыванию'], $frd['products'] ?? old('products') ?? null, [
	'placeholder' => 'Кол-во акций',
	'class' => 'form-control js-switch-ordering mr-2 mb-3'
]) !!}
<div class="btn-group mb-3" role="group">
    <a class="btn btn-outline-secondary " href="{{ route('organizations.index') }}"
