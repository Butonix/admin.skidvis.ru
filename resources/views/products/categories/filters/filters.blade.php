{!! Form::open(['url' => route('categories.index'), 'method' => 'GET', 'class' => 'form-inline onChangeSubmit']) !!}
...
{!! Form::select('type', ['products' => 'Для акций', 'blog' => 'Для блога', 'favorites' => 'Избранное'], $frd['type'] ?? old('type') ?? null, [
