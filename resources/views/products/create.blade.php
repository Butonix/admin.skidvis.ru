...
@section('content')
    <div class="container pb-lg-5 px-0">
        {{ Form::open(['url' => route('products.store', $organization), 'method' => 'post']) }}
        <div class='product'>
            <div class='row mx-0 mb-3 justify-content-end'>
                <div class="btn-group">
                    <button type='submit' class="btn btn-success" onclick='return confirm("Создать акцию?")'>
                        Создать
                    </button>
                </div>
            </div>
                ...
                <div class='col-lg-8 order-2 order-sm-2 order-md-2 order-lg-1 mt-4 mt-lg-0'>
                    <div class='row'>
                        <div class='col-lg-12 image-container'>
                            ...
                            <div id='image-container-store' data-action='{{ route('products.image.store2') }}'></div>
                                ...
                                <div class='col-lg-auto mr-3'>
                                    <div class='row justify-content-center'>
                                        <div class='organization__avatar'>
                                            <img src="{{ ($organization->getAvatar()) ? $organization->getAvatar()->getPublishPath() : '' }}" class="img-fluid rounded img-thumbnail">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class='row product__time mt-2'>
                        <div class='col-lg-12'>
                            <div class="form-group row justify-content-between {{ (isset($errors) && $errors->has('origin_price')) ? ' has-danger' : '' }}">
                                ...
                                <div class="col-lg col-md col-sm col mb-lg-0 mb-2">
                                    {{ Form::input('number', 'origin_price', null, [
										'required' => true,
