...
@section('content')
    ...
    <div class="row mb-4">
        <div class="col">
            <h4 id="list-1">1. Общие положения</h4>
            <span>
                ...
                данных <mark for="name">ООО "Скидвис"</mark> (далее – Оператор).
            </span>
            <ol class='mt-4'>
                <li>
                ...
                <li>
                    ...
                    применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <mark for="site">https://skidvis.ru</mark>.
                </li>
            </ol>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col">
            <h4 id="list-2">2. Основные понятия, используемые в Политике</h4>
            <ol class='mt-4'>
                <li>
                ...
                <li>
                    ...
                    данных, обеспечивающих их доступность в сети интернет по сетевому адресу <mark for="site">https://skidvis.ru</mark>.
                </li>
                <li>
                ...
                <li>
                    ...
                    определяемому Пользователю веб-сайта <mark for="site">https://skidvis.ru</mark>.
                </li>
                <li>
                    Пользователь – любой посетитель веб-сайта <mark for="site">https://skidvis.ru</mark>.
                </li>
                <li>
                ...
                <li>
                    ...
                    в информационной системе персональных данных и (или) результате
    ...
    <div class="row mb-4">
        <div class="col">
            <h4 id="list-3">3. Оператор может обрабатывать следующие персональные данные Пользователя</h4>
            <ol class='mt-4' for="dataTargetResult">
                <li>
    ...
    <div class="row mb-4">
        <div class="col">
            <h4 id="list-4">4. Цели обработки персональных данных</h4>
            <ol class='mt-4'>
                <li>
                    Цель обработки персональных данных Пользователя — <mark for="processingTargetResult">информирование Пользователя посредством отправки электронных
                        писем; уточнение деталей заказа. </mark>
                </li>
                <li>
                    ...
                    почты  <mark for="email">info@skidvis.ru </mark> с пометкой «Отказ от уведомлениях о новых продуктах и услугах и специальных предложениях».
                </li>
                <li>
    ...
    <div class="row mb-4">
        <div class="col">
            <h4 id="list-5">5. Правовые основания обработки персональных данных</h4>
            <ol class='mt-4'>
                <li>
                    ...
                    <mark for="site">https://skidvis.ru</mark>. Заполняя соответствующие
                    формы и/или отправляя свои персональные данные Оператору, Пользователь выражает свое согласие с
                    данной Политикой.
                </li>
                <li>
    ...
    <div class="row mb-4">
        <div class="col">
            <h4 id="list-6">6. Порядок сбора, хранения, передачи и других видов обработки персональных данных</h4>
            <span>
            ...
            <ol class='mt-4'>
                ...
                <li>
                    ...
                    <mark for="email">info@skidvis.ru </mark>
                    с пометкой «Актуализация
                    персональных данных».
                </li>
                <li>
    ...
    <div class="row mb-4">
        <div class="col">
            <h4 id="list-7">7. Трансграничная передача персональных данных</h4>
            <ol class='mt-4'>
                <li>
                ...
                <li>
                    ...
                    его персональных данных и/или исполнения договора, стороной которого является субъект персональных
                    данных.
                </li>
            </ol>
        </div>
    ...
    <div class="row mb-4">
        <div class="col">
            <h4 id="list-8">8. Заключительные положения</h4>
            <ol class='mt-4'>
                <li>
                ...
                <li>
                    ...
                    <mark for="link">https://skidvis.ru/policy</mark>.
                </li>
            </ol>
        </div>
    </div>
