<div class="container px-0">
    <div class="row">
        <div class="col-lg-auto">
            {!! Form::open(['url' => route('users.organizations', $user), 'method' => 'GET', 'class' => 'form-inline onChangeSubmit']) !!}
            ...
            <div class="btn-group mb-3" role="group">
                <a class="btn btn-outline-secondary" href="{{ route('users.organizations', $user) }}"
